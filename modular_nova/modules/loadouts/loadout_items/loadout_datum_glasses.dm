...
/datum/loadout_item/glasses/robopatch
	...
	restricted_roles = list(JOB_SCIENTIST, JOB_ROBOTICIST, JOB_GENETICIST, JOB_RESEARCH_DIRECTOR) // SS1984 REMOVAL: JOB_SCIENCE_GUARD
	group = "Job-Locked"
...
/datum/loadout_item/glasses/medicpatch
	...
	restricted_roles = list(JOB_MEDICAL_DOCTOR, JOB_CHIEF_MEDICAL_OFFICER, JOB_GENETICIST, JOB_CHEMIST, JOB_VIROLOGIST, JOB_PARAMEDIC, JOB_CORONER) // SS1984 REMOVAL: JOB_ORDERLY
	group = "Job-Locked"
...
/datum/loadout_item/glasses/mesonpatch
	...
	restricted_roles = list(JOB_QUARTERMASTER, JOB_CARGO_TECHNICIAN, JOB_SHAFT_MINER, JOB_CHIEF_ENGINEER, JOB_STATION_ENGINEER, JOB_ATMOSPHERIC_TECHNICIAN) // SS1984 REMOVAL: JOB_CUSTOMS_AGENT, JOB_ENGINEERING_GUARD
	group = "Job-Locked"
...
/datum/loadout_item/glasses/scipatch
	...
	restricted_roles = list(JOB_SCIENTIST, JOB_ROBOTICIST, JOB_GENETICIST, JOB_RESEARCH_DIRECTOR, JOB_CHEMIST, JOB_VIROLOGIST) // SS1984 REMOVAL: JOB_SCIENCE_GUARD
	group = "Job-Locked"
	group = "Job-Locked"
...
/datum/loadout_item/glasses/sechud
	...
	restricted_roles = list(JOB_SECURITY_OFFICER, JOB_WARDEN, JOB_HEAD_OF_SECURITY, JOB_CORRECTIONS_OFFICER, JOB_SECURITY_OFFICER_SERVICE, JOB_SECURITY_OFFICER_MEDICAL, JOB_SECURITY_OFFICER_SCIENCE, JOB_SECURITY_OFFICER_SUPPLY, JOB_SECURITY_OFFICER_ENGINEERING, JOB_BLUESHIELD, JOB_DETECTIVE) // SS1984 EDIT: JOB_SCIENCE_GUARD => JOB_SECURITY_OFFICER_SCIENCE, JOB_ENGINEERING_GUARD => JOB_SECURITY_OFFICER_ENGINEERING, JOB_BOUNCER => JOB_SECURITY_OFFICER_SERVICE, JOB_CUSTOMS_AGENT => JOB_SECURITY_OFFICER_SUPPLY, JOB_ORDERLY = JOB_SECURITY_OFFICER_MEDICAL
	group = "Job-Locked"
