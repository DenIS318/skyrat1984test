...
GLOBAL_LIST_INIT(radiochannels, list(
	...
	RADIO_CHANNEL_PRISON = FREQ_PRISON, //SS1984 EDIT ADDITION - PRISONERS HEADSETS
...
GLOBAL_LIST_INIT(reverseradiochannels, list(
	...
	"[FREQ_PRISON]" = RADIO_CHANNEL_PRISON, //SS1984 ADDITION - PRISONERS HEADSETS
